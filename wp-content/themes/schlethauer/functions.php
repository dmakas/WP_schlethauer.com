...
if ( ! function_exists( 'schlethauer_setup' ) ) :
	/**
	 ...
	 */
	function schlethauer_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Schlethauer, use a find and replace
		 * to change 'schlethauer' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'schlethauer', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'schlethauer' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'schlethauer_custom_background_args', array(
...
add_action( 'after_setup_theme', 'schlethauer_setup' );
 ...
 */
function schlethauer_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'schlethauer_content_width', 640 );
}
add_action( 'after_setup_theme', 'schlethauer_content_width', 0 );
 ...
 */
function schlethauer_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'schlethauer' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'schlethauer' ),
...
add_action( 'widgets_init', 'schlethauer_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'schlethauer_scripts' );
