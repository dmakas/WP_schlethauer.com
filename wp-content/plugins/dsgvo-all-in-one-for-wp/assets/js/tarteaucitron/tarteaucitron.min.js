        ...
        tarteaucitron.addScript(pathToLang, '', function () {
          ...
          if(tarteaucitronCustomText !== ''){
            ...
            tarteaucitron.addScript(pathToServices, '', function () {
                ...
                html += '            <b><a href="javascript:void(0)" onclick="tarteaucitron.userInterface.toggle(\'tarteaucitronInfo\', \'tarteaucitronInfoBox\');return false">&#10011;</a> ' + tarteaucitron.lang.all + '</b>';
                html += '         </div>';
        ...
        "number": function () {
            ...
            if (document.cookie !== '') {
                for (i = 0; i < nb; i += 1) {
                    ...
                    html += '    <div class="tarteaucitronCookiesListLeft"><a href="javascript:void(0)" onclick="tarteaucitron.cookie.purge([\'' + cookies[i].split('=', 1) + '\']);tarteaucitron.cookie.number();tarteaucitron.userInterface.jsSizing(\'cookie\');return false"><b>&times;</b></a> <b>' + name + '</b>';
                    html += '    </div>';
